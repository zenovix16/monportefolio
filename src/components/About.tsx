      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid lg:grid-cols-[1fr_1.3fr] gap-10 lg:gap-16 items-start">
          ...
          >
            ...
            <p className="text-black/65 leading-relaxed text-sm mb-3">
            ...
            <p className="text-black/45 leading-relaxed text-sm mb-6">
            ...
            <div className="grid sm:grid-cols-3 gap-3">
              {[
                ...
                <div key={s.label} className="glass rounded-xl px-4 py-4">
                  ...
                  <span className="text-black/50 text-xs">{s.label}</span>
                </div>
              ))}
            </div>

            <div className="glass rounded-xl px-5 py-4 mt-3">
              <p className="text-[10px] tracking-widest uppercase text-black/40 mb-3">Langues</p>
              <div className="flex gap-6">
                <div>
                  <p className="text-[#14161A] text-sm font-medium">Français</p>
                  <p className="text-black/45 text-xs mt-0.5">Niveau C1</p>
                </div>
                <div className="w-px bg-black/10" />
                <div>
                  <p className="text-[#14161A] text-sm font-medium">Anglais</p>
                  <p className="text-black/45 text-xs mt-0.5">Niveau B2</p>
                </div>
              </div>
            </div>
          </motion.div>
